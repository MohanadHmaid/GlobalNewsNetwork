...
// Pagination setup (if not already there)
...
if (!empty($search_query)) {
    ...
    $total_articles = count($article->search($search_query, 1, 1000)); // for pagination
} elseif ($category_filter) {
    $articles = $article->getByCategory($category_filter, $page, $limit);
    $total_articles = count($article->getByCategory($category_filter, 1, 1000));
} else {
...
$articles = $article->getByCategory($category_id, $page, $limit);

// Get total count for pagination
$total_articles = count($article->getByCategory($category_id, 1, 1000)); // Get total for pagination
...
<head>
    ...
    <title><?php echo htmlspecialchars($category_data['category_name']); ?> - Global News Network</title>
                ...
                <ul class="nav-list">
                    ...
                    <?php foreach ($categories as $cat): ?>
                        <li><a href="category.php?id=<?php echo $cat['category_id']; ?>" 
                               class="nav-link <?php echo $category_id == $cat['category_id'] ? 'active' : ''; ?>">
        ...
        <div class="container">
            <div class="content-grid">
                ...
                <section class="category-section">
                    <h2 class="section-title"><?php echo htmlspecialchars($category_data['category_name']); ?> News</h2>
                ...
                <!-- Sidebar (without categories section) -->
                <aside class="sidebar">
